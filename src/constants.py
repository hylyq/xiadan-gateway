...
MAIN_WINDOW_TITLE_KEYWORD = "网上股票交易系统"  # 关键字匹配，不含版本号，兼容券商升级
...
# ============================================================
# 服务器错误弹窗关键词（输入股票代码后自动查询价格/切换价
# 格模式时，若券商服务器维护，会弹出"事务处理机转发数据失败"
# 等提示弹窗，需要自动关闭）
# ============================================================
...
# ============================================================
# 阻塞型提示弹窗关键词（WindowService/PositionService/TradingService
# 共用，此前在三个文件里各硬编码一份）
# 非交易时段进入撤单/查询界面时可能弹出"Begin failed!"等提示窗，
# 阻挡后续操作，需要检测并关闭
# ============================================================
